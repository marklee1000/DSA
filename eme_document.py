...
def analyze_document(text_widget, search_word_entry, results_text, notebook):
    ...
    notebook.select(1)  # Index 1 corresponds to the Analysis tab
...
def redo_last_analysis(results_text, notebook):
...
# Analyze Button
analyze_button = ttk.Button(analysis_frame, text="Analyze Document", command=lambda: analyze_document(text, search_word_entry, results_text, notebook))
...
redo_button = ttk.Button(analysis_frame, text="Redo", command=lambda: redo_last_analysis(results_text, notebook))
